...
public class ViewPostActivity extends BaseActivity {
    ...
    private final ThreadLocal<PostListViewAdapter> adapter;

    {
        adapter = new ThreadLocal<PostListViewAdapter>() {
            /**
             * @return
             */
            @Override
            protected PostListViewAdapter initialValue() {
                return new PostListViewAdapter(this, R.layout.post_item, postList);
            }
        };
    }
    ...
    private final ThreadLocal<ValueEventListener> eventListener;

    {
        eventListener = new ThreadLocal<>();
    }
    ...
    private void showMyPost(){
        ...
        adapter.get().updateList(myPosts);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == android.R.id.home){
            ...
            adapter.get().updateList(postList);
            return true;
        }
    ...
    protected void onStop() {
        ...
        if(eventListener.get() != null){
            postReference.removeEventListener(eventListener.get());
        }
